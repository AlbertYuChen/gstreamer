...
#define __GMP_CFLAGS "-Wall -g -Os --sysroot=/home/slomo/Projects/android/android-ndk-r10c/platforms/android-9/arch-arm -I/home/slomo/Projects/android/android-ndk-r10c/platforms/android-9/arch-arm/usr/include -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -fPIC -mthumb -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64  -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -DANDROID -DPIC -D__ARM_ARCH_7A__  -Wa,--noexecstack"
